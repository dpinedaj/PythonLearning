...
############################################################################################
def abrir():
    ventana.filename = filedialog.askopenfilename(initialdir = 'G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/imagenes',title = "Elige Tu Archivo De Imagen:", filetypes = (("Imagenes PNG", "*.png"),("Imagenes GIF ", "*.gif")))    
    global ruta    
...
def grises():
    ...
    while i < im2.size[0]:
        ...
        i+=1
    g = im2.convert('L')
    g.save('G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/grises.gif') 
    imagenL = PhotoImage(file = 'G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/grises.gif')
    global grisesito
...
def negativo():    
    nombre = 'grises.gif'
    im = Image.open("G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/imagenes" + nombre)
    im15 = im
    i = 0
    while i < im15.size[0]:
        j = 0
        while j < im15.size[1]:
            ...
            j+=1
        i+=1
    im15.save('G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/negativo.gif') 
    imagenL = PhotoImage(file = 'G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/negativo.gif')
    global neg
        ...
        for x in range(ren):
            for y in range(col):
                if pixeles[x,y] >= alpha:
                    ...
                    binPix[x,y] = (0,0,0)
        imBinaria.save('G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/binarizar.gif') 
        imagenL = PhotoImage(file = 'G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/binarizar.gif')
        global binaria
...
def rbg():
    ...
    while i<ren:
        ...
        while j<col:
            ...
            j+=1
        i+=1
    out.save('G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/rbg.gif') 
    imagenL = PhotoImage(file = 'G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/rbg.gif')
    global rbg
...
def gbr():
    ...
    while i<ren:
        ...
        while j<col:
            ...
            j+=1
        i+=1
    out.save('G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/gbr.gif') 
    imagenL = PhotoImage(file = 'G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/gbr.gif')
    global gbr
...
def grb():
    ...
    while i<ren:
        ...
        while j<col:
            ...
            j+=1
        i+=1
    out.save('G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/grb.gif') 
    imagenL = PhotoImage(file = 'G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/grb.gif')
    global grb
...
def brg():
    ...
    while i<ren:
        ...
        while j<col:
            ...
            j+=1
        i+=1
    out.save('G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/brg.gif') 
    imagenL = PhotoImage(file = 'G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/brg.gif')
    global brg
...
def bgr():
    ...
    while i<ren:
        ...
        while j<col:
            ...
            j+=1
        i+=1
    out.save('G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/bgr.gif') 
    imagenL = PhotoImage(file = 'G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/bgr.gif')
    global bgr
...
def transpuesta():
    ...
    im7.save('G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/transpuesta.gif') 
    imagenL = PhotoImage(file = 'G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/transpuesta.gif')
    global trans   
...
def histograma():
    ...
    plt.plot(vec)
    plt.savefig('G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/histograma.png', dpi=80)
    imagenL = PhotoImage(file = 'G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/histograma.png')
    global hist
    ...
    if alpha==0:
        ...
        while i < im11.size[0]:
            ...
            while j < im11.size[1]:
                ...
                j+=1
            i+=1
        im11.save('G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/suma.gif') 
        imagenL = PhotoImage(file = 'G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/suma.gif')
        global sumita
    ...
    if alpha==0:
        ...
        while i < im12.size[0]:
            ...
            while j < im12.size[1]:
                ...
                j+=1
            i+=1
        im12.save('G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/resta.gif') 
        imagenL = PhotoImage(file = 'G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/resta.gif')
        global restita
    ...
    if alpha==0:
        ...
        while i < im13.size[0]:
            ...
            while j < im13.size[1]:
                ...
                j+=1
            i+=1
        im13.save('G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/multiplicar.gif') 
        imagenL = PhotoImage(file = 'G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/multiplicar.gif')
        global multi
    ...
    if alpha==0:
        ...
        while i < im14.size[0]:
            ...
            while j < im14.size[1]:
                ...
                j+=1
            i+=1
        im14.save('G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/dividir.gif') 
        imagenL = PhotoImage(file = 'G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/dividir.gif')
        global div
...
def binaria_And():
    ...
    if esc==0:
        ...
        out.save('G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/And.gif')
        imagenL = PhotoImage(file='G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/And.gif')
        global And        
...
def binaria_Or():
    ...
    if esc==0:
        ...
        while i<col:
            ...
            i+=1
        out = Image.fromarray(m)
        out.save('G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/Or.gif')
        imagenL = PhotoImage(file='G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/Or.gif')
        global Or        
    ...
    #   alpha = cuadrada 2, cubica 3, raiz cuadrada 1/2(0.5), raiz cubica 1/3(0.33)
        ...
        while reg1<arreglo[0]:
            ...
            while col1<arreglo[1]:
                ...
                col1+=1
            reg1+=1
        ima.save('G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/gamma.gif') 
        imagenL = PhotoImage(file = 'G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/gamma.gif')
        global gam
...
def logaritmica():
    ...
    while reg1<arreglo[0]:
        ...
        while col1<arreglo[1]:
            ...
            col1+=1
        reg1+=1
    ima.save('G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/logaritmica.gif') 
    imagenL = PhotoImage(file = 'G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/logaritmica.gif')
    global loga
...
def convolucion():    
    ...
    imagen2.save('G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/convolucion.gif') 
    imagenL = PhotoImage(file = 'G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/convolucion.gif')
    global convol    
...
def gaussiano():
    nombre = 'grises.gif'
    l = scipy.misc.imread("G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/imagenes" + nombre)
    noisy = l + 0.4 * l.std() * np.random.random(l.shape)
    plt.imshow(noisy, cmap=plt.cm.gray, vmin=40, vmax=220)
    plt.axis('off')
    plt.savefig('G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/gaussiano.png', dpi=90)
    imagenL = PhotoImage(file = 'G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/gaussiano.png')
    global gauss
    ...
    if prob==0:
        ...
        for i in range(nMaxRen):
            ...
            if aaa > 128:
                ...
                val= 1
                sal.putpixel((cy, cx),(val))
        sal.save('G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/sal.gif') 
        imagenL = PhotoImage(file = 'G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/sal.gif')
...
def ecualizacion_uniforme():    
    ...
    newim.save('G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/ecualizacionUniforme.gif') 
    imagenL = PhotoImage(file = 'G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/ecualizacionUniforme.gif')
...
def ecualizacion_exponencial():   
    ...
    if alpha==0.0:
        ...
        while i < ren:
            ...
            i+=1
        newim = Image.fromarray(newim)
        newim.save('G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/ecualizacionExponencial.gif') 
        imagenL = PhotoImage(file = 'G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/ecualizacionExponencial.gif')
        global ecualizacionExponencial    
        ecualizacionExponencial = canvas.create_image(600, 160, anchor=NW, image=imagenL)
        ventana.mainloop()
############################################################################################
def ecualizacion_rayleigh():   
    ...
    if alpha==0:
        ...
        while i < ren:
            ...
            i+=1
        newim = Image.fromarray(newim)
        newim.save('G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/ecualizacionRayleigh.gif') 
        imagenL = PhotoImage(file = 'G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/ecualizacionRayleigh.gif')
...
def ecualizacion_hypercubica():   
    ...
    imagenL = PhotoImage(file = 'G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/ecualizacionHypercubica.gif')
...
def ecualizacion_hyperbolica(): 
    ...
    while i < ren:
        ...
        i+=1
    newim = Image.fromarray(newim)
    newim.save('G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/ecualizacionHyperbolica.gif') 
    imagenL = PhotoImage(file = 'G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/ecualizacionHyperbolica.gif')
...
def filtro_maximo():    
    ...
    while i < ren - 3:
        ...
        while j < col - 3:
            ...
            j+=1
        i+=1
    out.save('G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/filtroMaximo.gif') 
    imagenL = PhotoImage(file = 'G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/filtroMaximo.gif')
    global filtroMaximo    
...
def filtro_minimo():    
    ...
    while i < ren - 3:
        ...
        while j < col - 3:
            ...
            j+=1
        i+=1
    out.save('G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/filtroMinimo.gif') 
    imagenL = PhotoImage(file = 'G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/filtroMinimo.gif')
    global filtroMinimo    
...
def filtro_mediana():   
    ...
    while i < ren - 3:
        ...
        while j < col - 3:
            ...
            j+=1
        i+=1
    out.save('G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/filtroMediana.gif') 
    imagenL = PhotoImage(file = 'G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/filtroMediana.gif')
...
def filtro_moda():    
    ...
    while i < ren - 3:
        ...
        while j < col - 3:
            ...
            j+=1
        i+=1
    out.save('G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/filtroModa.gif') 
    imagenL = PhotoImage(file = 'G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/filtroModa.gif')
    global filtroModa    
...
def bordes_sobel():
    ...
    for i in range(ren):
        for j in range(col):
            ...
            out[i, j] = suma
    out_im.save('G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/bordesSobel.gif') 
    imagenL = PhotoImage(file = 'G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/bordesSobel.gif')
    global bordesSobel    
...
def bordes_canny():  
    ...
    ax2.axis('off')
    plt.savefig('G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/bordesCanny.png')
    imagenL = PhotoImage(file = 'G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/bordesCanny.png')
    global bordesCanny    
...
def erosion():
    ...
    plt.axis('off')
    plt.savefig('G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/erosion.png')
    imagenL = PhotoImage(file = 'G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/erosion.png')
    global ero    
...
def dilatacion():
    ...
    plt.axis('off')
    plt.savefig('G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/dilatacion.png')
    imagenL = PhotoImage(file = 'G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/dilatacion.png')
    global dil    
...
def opening():
    ...
    plt.axis('off')
    plt.savefig('G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/apertura.png')
    imagenL = PhotoImage(file = 'G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/apertura.png')
    global ape
...
def otsu():
    ...
    im_otsu.save('G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/otsu.gif') 
    imagenL = PhotoImage(file = 'G:/TEC/7 SEMESTRE/Procesamiento Digital De Imagenes/Programas (Con Interfaz)/resultados/otsu.gif')
    global Otsu    
