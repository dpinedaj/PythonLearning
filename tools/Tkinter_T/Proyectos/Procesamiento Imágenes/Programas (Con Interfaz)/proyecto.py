...
def abrir():
    ventana.filename = filedialog.askopenfilename(
        initialdir="C:/Users/CkriZz/Pictures/PROYECTOFINAL",
...
def grises():
    ...
    imagenL = PhotoImage(
        file="C:/Users/CkriZz/Pictures/PROYECTOFINAL/RESULTADOS/grises.gif"
    )
    global grisesito
...
def otsu():
    ...
    imagenL = PhotoImage(
        file="C:/Users/CkriZz/Pictures/PROYECTOFINAL/RESULTADOS/otsu.gif"
    )
    global Otsu
...
def fondo():
    ...
    imagenL = PhotoImage(
        file="C:/Users/CkriZz/Pictures/PROYECTOFINAL/RESULTADOS/fondo.gif"
    )
    global Otsu
    Otsu = canvas.create_image(600, 150, anchor=NW, image=imagenL)
    ventana.mainloop()
