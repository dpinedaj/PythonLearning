...
class Board:
    ...
    def check_for_winner(self, player):
        ...
        and self.cell_contains(c, 0, 2)) or (self.cell_contains(c, 1, 0) 
        and self.cell_contains(c, 1, 1) 
        and self.cell_contains(c, 1, 2)) or (self.cell_contains(c, 2, 0) 
        and self.cell_contains(c, 2, 1) 
        and self.cell_contains(c, 2, 2)) or (self.cell_contains(c, 0, 0) 
        and self.cell_contains(c, 1, 0) 
        and self.cell_contains(c, (self.cell_contains(c, 0, 1) 
            and self.cell_contains(c, 1, 1) 
            and self.cell_contains(c,
